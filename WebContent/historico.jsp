<%@page import="business.HistoricoBusiness"%>
<%@page import="dto.DtoHistorico"%>
...
%>
<%
	List<DtoHistorico> historicos = (List<DtoHistorico>)session.getAttribute("historico");
%>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a class="active" class="nav nav-second-level"
							style="color: black;" href="historico.jsp"><span
						...
						<form role="form" action="principal.jsp" method="post">
							<div class="table-responsive">
								<table class="table table-hover">
									...
									<tbody>
										<%
											for (DtoHistorico historicoDTO : historicos) {
										%>
										<tr>
											<td><%=historicoDTO.getCodigoMusica().getNome()%></td>
											<td><%=historicoDTO.getCodigoMusica().getArtista().getNome()%></td>
											<td><%=historicoDTO.getCodigoMusica().getGenero().getNome()%></td>
											<td><%=historicoDTO.getData()%></td>
											<%
												}
											%>
